...
public class CodeGenerator {
    ...
    public static void main(String[] args) {
        ...
        //xml开启BaseResultMap和BaseColumnList
...
//         dsc.setSchemaName("public");
        ...
        pc.setParent("com.blue.server").setEntity("pojo").setController("controller").setServiceImpl("service.impl").setService("service").setMapper("mapper");
